...
let steven = new CrewMember ("Steven", "Captain", "Fast")
let newShip = new Ship ("new", "large", "fast")
let cesar = new CrewMember ("Cesar", "LT", "Intelligent")
console.log(steven)
steven.enterShip(newShip)
cesar.enterShip(newShip)
console.log(steven)
console.log(newShip.crew)
